...
VideoPQ.prototype.render = function (_parent) {
  ...
  var i;
  for (i = 0; i < this.config.videoQuestionnaire.length; ++i) {
    var element = this.config.videoQuestionnaire[i];
...
VideoPQ.prototype.store = function () {
  ...
  for (i = 0; i < this.pageConfig.questionnaire.length; ++i) {
    ...
    questionnaire.name[questionnaire.name.length] = this.questionnaire.name[i];
    questionnaire.response[questionnaire.response.length] = this.questionnaire.response[i];
  }
